...
<body>
    ...
    <section id="body-pd">
        ...
        <div class="l-navbar mb-5" id="nav-bar">
            <nav class="nav">
                <div> <a href="#" class="nav_logo"> <i class='bx bx-dish nav_logo-icon'></i> <span
                            class="nav_logo-name">Delicious</span> </a>
                    <div class="nav_list">
                        <a href="{{ route('admin.dashboard') }}" class="nav_link active"> <i class='bx bx-grid-alt nav_icon'></i>
                            <span class="nav_name">Dashboard</span> </a>
                             <a href="#" class="nav_link"> <i
                                class='bx bx-user nav_icon'></i> <span class="nav_name">Users</span> </a>
                                 <a href="{{ route('admin.dishes') }}"
                            class="nav_link"> <i class='bx bx-dish nav_icon'></i> <span
                                class="nav_name">Dishes</span> </a> 
                                <a href="#" class="nav_link"> <i
                                class='bx bx-book-bookmark nav_icon'></i> <span class="nav_name">Bookings</span> </a> <a
